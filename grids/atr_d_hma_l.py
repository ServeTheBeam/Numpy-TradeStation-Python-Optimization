"""Grid definitions for ATR-D HMA v1.5 Long-only.

Parameter order MUST match the kernel's p0..p12 signature:
  ...
  p11=hma_fast_length, p12=hma_slow_length
"""
...
# ---------------------------------------------------------------------------
# ts_coarse — Match TS coarse grid (from _ATR-D-HMA-v1.5-L_coarse.csv)
# ---------------------------------------------------------------------------
_register("ts_coarse", {
    ...
    "hma_fast_length":     np.arange(15, 56, 8, dtype=np.int64),   # 15,23,31,39,47,55
    "hma_slow_length":     np.arange(45, 86, 10, dtype=np.int64),  # 45,55,65,75,85
})

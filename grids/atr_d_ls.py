"""Grid definitions for ATR-D v1.5 Long/Short.
...
# ---------------------------------------------------------------------------
# ts_coarse — Match TS coarse grid (from _ATR-D-v1.5-LS_coarse.csv)
# ---------------------------------------------------------------------------
_register("ts_coarse", {
    "atr_period":           np.array([8, 32, 56], dtype=np.int64),
    "atr_multiplier":       np.arange(4, 21, 4, dtype=np.float64),         # 4,8,12,16,20
    ...
    "atr_smooth_period":    np.array([4, 12], dtype=np.int64),
